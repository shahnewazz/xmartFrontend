        ...
        <div class="row">
          <div class="col-sm-6 col-xl-3">
            <div class="footer-widget">
              <router-link :to="{name:'home'}"  class="footer-logo"><img src="@/assets/images/logo.png" alt="logo" /></router-link>
              <p class="footer-desc">
            ...
            <div class="footer-bottom">
              ...
              <div class="footer-card">
                <a href="#"><img src="@/assets/images/payment/jpg/01.jpg" alt="payment" /></a><a href="#"><img
                    src="@/assets/images/payment/jpg/02.jpg" alt="payment" /></a><a href="#"><img
                    src="@/assets/images/payment/jpg/03.jpg" alt="payment" /></a><a href="#"><img
                    src="@/assets/images/payment/jpg/04.jpg" alt="payment" /></a>
              </div>
            </div>
          </div>
        </div>
